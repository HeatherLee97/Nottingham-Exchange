...
export const fetchStocksPrices = (stockSymbols) => async (dispatch) => {
  console.log(JSON.stringify({stock_symbols: JSON.stringify(stockSymbols)}), "STOCKARRAY BEFORE")
...
export const fetchHistoricalData = (stocksInfo) => async (dispatch) => {
  console.log(JSON.stringify({stocks_info : JSON.stringify(stocksInfo)}), "STOCKARRAYBEFORE")
    ...
    if (response.ok) {
      ...
      console.log(newData, "RESPONSEDATANEW")
